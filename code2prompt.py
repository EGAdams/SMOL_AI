...
print( "generated directory: " + generatedDir )
...
def walk_directory(directory):
    ...
    print( "returning code contents: " + str(code_contents ))
...
def main(prompt=None, directory="generated", model="gpt-3.5-turbo"):
  ...
  print( "code_contents: " + str(code_contents))
  #exit(0)
...
def generate_response(system_prompt, user_prompt, model="gpt-3.5-turbo", *args):
    ...
    openai.api_key = "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"
