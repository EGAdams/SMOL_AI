...
MAIN_OBJECTS=GameWinSequence.o SetWin.o SetHistoryText.o Drawer.o SetDrawer.o GameLedTranslator.o SubjectManager.o WebLiquidCrystal.o WatchTimer.o Inputs.o TieBreaker.o Mode1Score.o Mode1Functions.o ServeLeds.o Undo.o BatteryTest.o Reset.o SetLeds.o TieLeds.o WinSequences.o Mode2Functions.o MatchWinSequence.o TennisConstants.o GameLeds.o GameModes.o GameObject.o PinState.o PinInterface.o TranslateConstant.o PointLeds.o Arduino.o CanvasCreator.o FontLoader.o NumberDrawer.o TextDrawer.o GameTimer.o Logger.o History.o GameState.o ScoreBoard.o Player.o tennis-game.o
TEST_OBJECTS=GameState.o Player.o GameState.o GameTimer.o ScoreBoard.o Drawer.o SetDrawer.o NumberDrawer.o CanvasCreator.o FontLoader.o GameTimer.o
SCORE_TEST_OBJECTS=Reset.o SetLeds.o GameLeds.o PointLeds.o Undo.o SetWin.o GameState.o Player.o GameState.o GameTimer.o ScoreBoard.o Drawer.o SetDrawer.o  Mode1Score.o Mode1ScoreTest.o WinSequences.o TennisConstants.o GameModes.o GameObject.o PinState.o PinInterface.o TranslateConstant.o PointLeds.o Arduino.o CanvasCreator.o FontLoader.o NumberDrawer.o TextDrawer.o GameTimer.o Logger.o History.o GameState.o ScoreBoard.o Player.o tennis-game.o TieBreaker.o
...
clean:
	rm -f $( SCORE_TEST_OBJECTS ) $( MAIN_OBJECTS ) $( TEST_OBJECTS ) $( BINARIES )
