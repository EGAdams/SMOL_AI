I am having an import problem in my Python script:
Here is the output:
# Output
```bash
(hp_agent_env) adamsl@DESKTOP-SHDBATI:~/developer/smol_dev$ python3 start_building.py prompt.md 
Traceback (most recent call last):
  File "/home/adamsl/developer/smol_dev/start_building.py", line 4, in <module>
    from smol_dev.prompts import plan, specify_file_paths, generate_code_sync
ModuleNotFoundError: No module named 'smol_dev'
(hp_agent_env) adamsl@DESKTOP-SHDBATI:~/developer/smol_dev$ tree
.
├── __init__.py
├── api.py
├── main.py
...
# Your Task
Please show me how to fix the import issue.
